function togglePassword(button) {
    const inputElement = document.getElementById(button.dataset.target);

    inputElement.type = inputElement.type === 'password'
        ? 'text'
        : 'password';

    button.innerHTML = inputElement.type === 'password'
